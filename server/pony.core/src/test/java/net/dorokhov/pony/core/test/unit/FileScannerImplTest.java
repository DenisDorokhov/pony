...
public class FileScannerImplTest {
	...
	private void doTestRoot(LibraryFolder aFolder) {
		...
		for (LibraryFile file : aFolder.getImageFiles(true)) {
		...
		for (LibraryFile file : aFolder.getSongFiles(true)) {
